...
Available as: - **Python package** – `volaris` (`python/`) - **R
package** – `Volaris` (`R/Volaris/`)
...
**C/C++ backend (required for both packages)** - [GNU
GSL](https://www.gnu.org/software/gsl/) \>= 2.0: numerical integration -
OpenMP: parallelism in Monte Carlo and GARCH

**Python** - Python \>= 3.9 - `NumPy` \>= 1.21 - Cython

**R** - R \>= 4.0.0 - Rcpp

**Testing (optional)** - Python: `pytest` - R: `testthat`
